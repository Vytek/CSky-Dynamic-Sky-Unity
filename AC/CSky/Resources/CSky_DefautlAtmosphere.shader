	...
	CGINCLUDE
		...
		v2f vert(appdata v)
		{
			...
			//====================================================================================================================================
				...
				AtmosphericScattering(float3(ray.x, (ray.y+CSky_HorizonOffset), ray.z), o.inscatter, o.outscatter, 1);
				//================================================================================================================================
				...
				AtmosphericScattering(float3(ray.x, (ray.y+CSky_HorizonOffset), ray.z), inscatter, outscatter, 1);
				//================================================================================================================================
